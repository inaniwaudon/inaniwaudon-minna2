...
import thumbnail2025 from "@/assets/index/nenga2025.webp";

export const nengajo = [
  {
    year: 2025,
    src: "./assets/nenga2025.webp",
    thumbnail: thumbnail2025,
    width: 3495,
    height: 2362,
    alt: `「謹賀新年。旧年中は大変お世話になりました。本年もどうぞよろしくお願い申し上げます。」の文言が右上に添えられています。
    左側には、桜、夕暮れ、花火、京都タワー、山、大学の研究棟の写真が切り抜かれて並べられています。
    遠くから見ると、これらの写真が合わさって「桜」という漢字に見えるようになっています。
    右下には、黄色いまんまるのぬいぐるみが微笑んでいます。`,
  },
  {
    year: 2024,
