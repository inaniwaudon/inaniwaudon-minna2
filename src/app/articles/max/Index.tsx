        ...
        <PageWrapper>
          <Wrapper>
            ...
            <Content>
              <main>
                <H1>
                  <img src={logo} alt="マックスコーヒーのパッケージ観察" />
                </H1>
                <Abstract>
                  <AbstractContent>
                ...
                <section id="data">
                  ...
                  <Figure>
                    <FigureImage src={scannerImage} alt="" />
                    <Caption>図 1：スキャンの光景</Caption>
                  </Figure>
                  <Figure>
                    <FigureImage src={scannedImage} alt="" />
                  ...
                  <Figure>
                    <FigureImage src={maxTrace} alt="" border={true} />
                ...
                <section id="logo">
                  ...
                  <Figure>
                    <FigureImage src={maxLogo} alt="MAX COFFEE" />
                  ...
                  <Figure>
                    <FigureImage src={maxLogoAnalyze} alt="MAX COFFEE" />
                ...
                <section id="front">
                  ...
                  <Figure>
                    <FigureImage src={maxRedImage} alt="MAX COFFEE" />
                ...
                <section id="components">
                  ...
                  <Figure>
                    <FigureImage src={tel} alt="お客様相談室 0120-308509" />
                ...
                <Figure>
                  <FigureImage src={maxMakuhariImage} alt="" />
