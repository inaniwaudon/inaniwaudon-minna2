    ...
    <PageWrapper title={title} path="/articles">
      <Main>
        ...
        {p`――2024 年が終わります。
          ...
          昨年同様に本エントリ${fn("hatena")}をお送りしたいと思います。
        ...
        <H2>むすびにかえて</H2>
        {p`希薄になる人間関係も多かった一方で、比較的外出していたこと、人間とよくご飯を食べたこと、
          よく旅行に行ったことなどから、全体的にはかなり安定した一年でした。
          昨年よりも確実に良い月日が流れたと思います。`}
        {p`研究が苦しいのは衆目の一致するところですが、やるべきことが明確になったのは精神にプラスの影響を与えた${fn("shousou")}と思います。
          一方、学部 4 年になってから、自分も周囲も少しずつおかしくなっていったように漠然と感じる機会が増え、
          実際にそれを象徴するような出来事もありました。
          また、周囲の人生が確実に進んでいることは常日頃から理解しています${fn("life")}。
          自分を詳らかにしていきたいという思いが強まった一年でもありました。`}
        {p`末筆ながら、現在自分がこうして過ごせているのは、周囲の人々に恵まれていたからだと偏に実感しています。
          本当にありがとうございました。
