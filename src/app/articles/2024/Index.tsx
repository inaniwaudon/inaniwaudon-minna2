    ...
    <PageWrapper title={title} path="/articles">
      <Main>
        ...
        {p`恒例の学類同期との旅行では台湾に行きました。
          ...
          震災から 12 年を経た今でも、時間の停滞を実感させられたことを記憶しています。
        ...
        {p`昨年からの予想通り、人間関係はかなり激変した一年でした。
          ...
          研究室は交流が多い方${fn("kyusoku")}で、同期や先輩もおおらかな人達が多く、結構当たりを引いたと思っています。
          年度初めは環境の変化に対する不安もあったのですが、人間関係に大きな支障はなかったです${fn("talk")}。`}
        {p`研究室とは不思議な空間だと思います。
        ...
        {p`また、研究室では日本語の用法を細かく指導されているので、
          若干マシな文章が書けるようになっていたら良いなと期待しています。句読点がカンマ（，）とピリオド（．）に変わりました${fn("punc")}。`}
        ...
        {p`大晦日の振り返り記事は大学 1 年の頃に書き始めて、今年で 4 年目になります。
          ...
          文章として記録に残すとまた別の価値が生まれるものだと確信しています。`}
        {p`2024 年、みなさんはどんな一年でしたか？ 希薄になる人間関係も多かった一方で、
          比較的外出していたこと、人間とよくご飯を食べたこと、
          よく旅行に行ったことなどから、個人的にはかなり安定した一年でした。
          昨年よりは確実に良い月日を送れたと思います。
          生活の中心となる研究が苦しいのは衆目の一致するところですが、
          やるべきことが明確になったのは精神に好影響を与えました${fn("shousou")}。
          その一方で、学部 4 年になってから、自分も周囲も少しずつおかしくなっていったように漠然と感じる機会が増え、
          実際にそれを象徴するような出来事もありました。
          また、周囲の人生が確実に進んでいることも常日頃から直視させられています${fn("life")}。
          自分を詳らかにしていきたいという思いが強まった一年でもありました。`}
        {p`末筆ながら、現在自分が現在こうして過ごせているのは、周囲の人々に恵まれていたからだと偏に実感しています。
          本当にありがとうございました。
          来年は現状を維持しつつ、謙虚に振る舞いながら、生活が破綻しない程度に高みを目指していければと思います。`}
